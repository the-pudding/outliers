<script>
    ...
    let stains;
    let width;
    let stainImgs = ["assets/img/stain1.png", "assets/img/stain2.png", "assets/img/stain3.png", "assets/img/stain4.png", "assets/img/stain5.png"];
...
<div class="stains" style="height: {height}px" bind:clientWidth={width}>
    {#if stains != undefined}
        {#each stains as stain, i}
            <div style="top: {stain.randomH}px; left: {stain.randomW}px; transform: rotate({stain.randomRotate}deg); background-image: url('{stain.img}'), url('/assets/img/bg_texture.png')"></div>
        {/each}
    {/if}
</div>
